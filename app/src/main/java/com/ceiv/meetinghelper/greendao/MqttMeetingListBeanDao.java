package com.ceiv.meetinghelper.greendao;
...
public class MqttMeetingListBeanDao extends AbstractDao<MqttMeetingListBean, Long> {
    ...
    public static class Properties {
        ...
        public final static Property IsOpen = new Property(6, String.class, "isOpen", false, "IS_OPEN");
        ...
        public final static Property TemplateId = new Property(9, int.class, "templateId", false, "TEMPLATE_ID");
        public final static Property BookPerson = new Property(10, String.class, "bookPerson", false, "BOOK_PERSON");
        public final static Property BookPersonPhone = new Property(11, String.class, "bookPersonPhone", false, "BOOK_PERSON_PHONE");
    ...
    public static void createTable(Database db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"MQTT_MEETING_LIST_BEAN\" (" + //
                ...
                "\"NAME\" TEXT," + // 5: name
                "\"IS_OPEN\" TEXT," + // 6: isOpen
                "\"END_DATE\" INTEGER NOT NULL ," + // 7: endDate
                "\"START_DATE\" INTEGER NOT NULL ," + // 8: startDate
                "\"TEMPLATE_ID\" INTEGER NOT NULL ," + // 9: templateId
                "\"BOOK_PERSON\" TEXT," + // 10: bookPerson
                "\"BOOK_PERSON_PHONE\" TEXT," + // 11: bookPersonPhone
                "\"SIGN\" TEXT);"); // 12: sign
        // Add Indexes
    ...
    protected final void bindValues(DatabaseStatement stmt, MqttMeetingListBean entity) {
        ...
        if (isOpen != null) {
            stmt.bindString(7, isOpen);
        }
        stmt.bindLong(8, entity.getEndDate());
        stmt.bindLong(9, entity.getStartDate());
        stmt.bindLong(10, entity.getTemplateId());
 
        String bookPerson = entity.getBookPerson();
        if (bookPerson != null) {
            stmt.bindString(11, bookPerson);
        }
 
        String bookPersonPhone = entity.getBookPersonPhone();
        if (bookPersonPhone != null) {
            stmt.bindString(12, bookPersonPhone);
        }
    ...
    public MqttMeetingListBean readEntity(Cursor cursor, int offset) {
        MqttMeetingListBean entity = new MqttMeetingListBean( //
            ...
            cursor.isNull(offset + 6) ? null : cursor.getString(offset + 6), // isOpen
            cursor.getLong(offset + 7), // endDate
            cursor.getLong(offset + 8), // startDate
            cursor.getInt(offset + 9), // templateId
            cursor.isNull(offset + 10) ? null : cursor.getString(offset + 10), // bookPerson
            cursor.isNull(offset + 11) ? null : cursor.getString(offset + 11), // bookPersonPhone
    ...
    public void readEntity(Cursor cursor, MqttMeetingListBean entity, int offset) {
        ...
        entity.setIsOpen(cursor.isNull(offset + 6) ? null : cursor.getString(offset + 6));
        entity.setEndDate(cursor.getLong(offset + 7));
        entity.setStartDate(cursor.getLong(offset + 8));
        entity.setTemplateId(cursor.getInt(offset + 9));
        entity.setBookPerson(cursor.isNull(offset + 10) ? null : cursor.getString(offset + 10));
        entity.setBookPersonPhone(cursor.isNull(offset + 11) ? null : cursor.getString(offset + 11));
